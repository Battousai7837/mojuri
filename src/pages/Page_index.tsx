...
const HTML = `
		<div id="page" class="hfeed page-wrapper">
			...
			<div id="dynamic-home-products"></div>
...
export default function Page_index() {
  ...
  usePageScripts(ref, 'Mojuri – Jewelry Store HTML Template');
  return <><div ref={ref} dangerouslySetInnerHTML={{ __html: HTML }} /><HomeProducts /></>;
}
