						...
						<div id="title" class="page-title">
							<div class="section-container">
								...
								<div class="breadcrumbs">
									<a href="index.html">Home</a><span class="delimiter"></span>Bridial Fair Collections 2023
								</div>
							</div>
						</div>
...
export default function Page_blog_details_fullwidth() {
  const ref = useRef<HTMLDivElement>(null);
  usePageScripts(ref, 'Blog Details - No Sidebar | Mojuri');
